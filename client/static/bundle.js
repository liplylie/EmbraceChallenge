...
var EmbraceChallenge = function (_Component) {
  _inherits(EmbraceChallenge, _Component);

  function EmbraceChallenge(props) {
    _classCallCheck(this, EmbraceChallenge);

    return _possibleConstructorReturn(this, (EmbraceChallenge.__proto__ || Object.getPrototypeOf(EmbraceChallenge)).call(this, props));
  }

  _createClass(EmbraceChallenge, [{
    key: 'render',
  ...
  return EmbraceChallenge;
}(_react.Component);

_reactDom2.default.render(_react2.default.createElement(EmbraceChallenge, null), document.getElementById('app'));
...
var _addDogReducer = __webpack_require__(76);

var _addDogReducer2 = _interopRequireDefault(_addDogReducer);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var reducer = (0, _redux.combineReducers)({
	addDog: _addDogReducer2.default
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__isPromise_js__ = __webpack_require__(75);
...
var addDogReducer = function addDogReducer() {
